...
if (isset($_GET['kode_transaksi'])) {
    ...
    $queryDetailPinjam = mysqli_query($koneksi, "SELECT * FROM detail_peminjaman LEFT JOIN kategori ON kategori.id = detail_peminjaman.id_kategori LEFT JOIN book ON book.id = detail_peminjaman.id_buku WHERE id_peminjaman = '$id'");
