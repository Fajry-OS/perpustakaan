...
if (isset($_POST['simpan'])) {
    ...
    $kode_pengembalian = "PGAM" . date("dmY") . sprintf("%03s", $no_Urut);
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                <input placeholder="Keterlamabatan" type="text" readonly id="terlambat" name="terlambat" value="" class="form-control">
